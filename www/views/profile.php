...
<head>
  <?php include "include/head.inc.php" ?>
    <title>Fame on - Mon profil -  La télé-réalité comme vous ne l'avez jamais vu</title>
...
<body>
  <?php include("include/menu.inc.php"); ?>
    <main class="container">
      <div class="row">
        <div class="col-sm-6">
          <a href="http://twitter.com/intent/tweet/?url=http://<?php echo $_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']; ?>&text=&via=Alize_FameOnTV #FameOn">Partager sur Twitter</a>
